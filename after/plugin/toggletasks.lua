...
vim.keymap.set('n', '<space>ttr', require('telescope').extensions.toggletasks.spawn, { desc = 'toggletasks: spawn' })
vim.keymap.set('n', '<space>tts', require('telescope').extensions.toggletasks.select, { desc = 'toggletasks: select' })
vim.keymap.set('n', '<space>tte', require('telescope').extensions.toggletasks.edit, { desc = 'toggletasks: edit' })
